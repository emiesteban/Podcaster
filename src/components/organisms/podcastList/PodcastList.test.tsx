...
describe('PodcastList', () => {
  ...
  test('filters podcasts', () => {
    ...
    const input = screen.getByPlaceholderText('Filter podcasts...') as HTMLInputElement;

    fireEvent.change(input, {target: {value: 'Joe'}})
    mockContext.search = 'Joe';
    expect(mockContext.setSearch).toBeCalledWith('Joe');
  ...
  test('shows "No results" message', () => {
    ...
    expect(mockContext.setSearch).toBeCalledWith('invalid search');
